...
results1 = non_max_suppression_3d(boxes=boxes1, scores=scores1, max_output_size=max_output_size1)
...
results2 = non_max_suppression_3d(boxes=boxes2, scores=scores2, max_output_size=max_output_size2)
...
scores3 = scores1
max_output_size3 = 2
results3 = non_max_suppression_3d(boxes=boxes3, scores=scores3, max_output_size=max_output_size3)
...
max_output_size4 = 6
results4 = non_max_suppression_3d(boxes=boxes4, scores=scores4, max_output_size=max_output_size4)
...
scores5 = scores1
max_output_size5 = 30
results5 = non_max_suppression_3d(boxes=boxes5, scores=scores5, max_output_size=max_output_size5)
...
max_output_size6 = 3
results6 = non_max_suppression_3d(boxes=boxes6, scores=scores6, max_output_size=max_output_size6)
...
max_output_size7 = 3
results7 = non_max_suppression_3d(boxes=boxes7, scores=scores7, max_output_size=max_output_size7)
...
max_output_size8 = 30
try:
    results8 = non_max_suppression_3d(boxes=boxes8, scores=scores8, max_output_size=max_output_size8)
...
iou9 = 1.2
try:
    results9 = non_max_suppression_3d(boxes=boxes9, scores=scores9, max_output_size=max_output_size9, iou_threshold=iou9)
except Exception as e:
...
results10 = non_max_suppression_3d(boxes=boxes10, scores=scores10, max_output_size=max_output_size10)
